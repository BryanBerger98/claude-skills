...
The five decisions this action produces. They are held in conversation context and passed to actions 02+ as-is. **Not written to any file** — this block is illustrative, not a frontmatter schema.
...
8. Run the skill-vs-command heuristic from `references/skill-vs-command.md`. Single-action skill → recommend a slash command and stop.
